...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,618 | 🐛 251 | 🌐 Python | 📅 2026-09-08 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,623 | 🐛 68 | 🌐 Rust | 📅 2026-09-11 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,506 | 🐛 176 | 🌐 Go | 📅 2026-09-07 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,848 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,844 | 🐛 16 | 🌐 Go | 📅 2026-09-08 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 747 | 🐛 16 | 🌐 PHP | 📅 2026-09-10 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
* [dave](https://github.com/micromata/dave/) ⚠️ Archived - a simple WebDAV server written in Go. `Apache-2.0` `Golang`
* [Seafile](https://github.com/haiwen/seafdav) ⭐ 93 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - A webdav server written in Python
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,723 | 🐛 18 | 🌐 Rust | 📅 2026-06-29
  * [thecoshman/http](https://github.com/thecoshman/http) ⭐ 494 | 🐛 6 | 🌐 Rust | 📅 2026-08-07
  * [messense/dav-server-rs](https://github.com/messense/dav-server-rs) ⭐ 242 | 🐛 2 | 🌐 Rust | 📅 2026-05-04 library for WebDAV and there are a lot of [small webservers based on it](https://github.com/messense/dav-server-rs/network/dependents) ⭐ 242 | 🐛 2 | 🌐 Rust | 📅 2026-05-04.
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,952 | 🐛 1,477 | 🌐 TypeScript | 📅 2026-09-11.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,991 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-10.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 476 | 🌐 C++ | 📅 2026-09-08 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,982 | 🐛 626 | 🌐 C# | 📅 2026-09-11 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
* [ioBroker.backitup](https://github.com/simatec/ioBroker.backitup) ⭐ 72 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-10 - a module for ioBroker home automation.
* [rclone](https://rclone.org/) - Supports WebDAV as a backup target and [can itself act as a WebDAV server](https://rclone.org/commands/rclone_serve_webdav/) (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,562 | 🐛 79 | 🌐 Dart | 📅 2026-09-11 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,562 | 🐛 79 | 🌐 Dart | 📅 2026-09-11. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,332 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-10
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,573 | 🐛 1,549 | 🌐 Kotlin | 📅 2026-09-11 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,351 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
* [RCX](https://github.com/x0b/rcx) ⭐ 2,040 | 🐛 144 | 🌐 Java | 📅 2023-11-26 Rclone sync for Android (unmaintained, use Round Sync). `GPL-3.0`
* [alexbakker/webdav-provider](https://github.com/alexbakker/webdav-provider) ⭐ 262 | 🐛 3 | 🌐 Kotlin | 📅 2026-07-25 - WebDAV storage to other apps through Android's Storage Access Framework (SAF). `GPL-3.0`
* [EasySync](https://github.com/phpbg/easysync) ⭐ 231 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-15 - backup and sync files with WebDAV share. `MIT`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,657 | 🐛 962 | 🌐 HTML | 📅 2026-09-09 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,223 | 🐛 1,171 | 🌐 C# | 📅 2026-09-09. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,325 | 🐛 125 | 🌐 Dart | 📅 2026-09-07 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,562 | 🐛 79 | 🌐 Dart | 📅 2026-09-11 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,562 | 🐛 79 | 🌐 Dart | 📅 2026-09-11. `AL2` `Dart`  `Apache-2.0`
* [SimpleTask](https://github.com/mpcjanssen/simpletask-android) ⚠️ Archived - a simple task manager. `GPL3` `Kotlin`
* [ntodotxt](https://github.com/tmaegel/ntodotxt) ⭐ 224 | 🐛 40 | 🌐 Dart | 📅 2026-08-14 - TODO App with sync via WebDAV. `MIT`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,325 | 🐛 125 | 🌐 Dart | 📅 2026-09-07. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,562 | 🐛 79 | 🌐 Dart | 📅 2026-09-11 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,562 | 🐛 79 | 🌐 Dart | 📅 2026-09-11. `AL2` `Dart`  `Apache-2.0`
...
* [neon](https://github.com/notroj/neon) ⭐ 165 | 🐛 4 | 🌐 C | 📅 2026-08-09 - An HTTP/1.1 and WebDAV client library with a C API.
...
* <https://github.com/saguiitay/WebDAVClient> ⭐ 133 | 🐛 9 | 🌐 C# | 📅 2026-08-25

### Go

* [go-webdav](https://github.com/emersion/go-webdav) ⭐ 497 | 🐛 55 | 🌐 Go | 📅 2026-06-28 - Client library for WebDAV, CalDAV and CardDAV.
* [gowebdav](https://github.com/studio-b12/gowebdav) ⭐ 370 | 🐛 11 | 🌐 Go | 📅 2026-07-09 - WebDAV client library and command line tool.
...
* [sardine](https://github.com/lookfirst/sardine) ⭐ 624 | 🐛 23 | 🌐 Java | 📅 2026-03-09 - Java client based on Apache HTTP Client. `Apache-2.0`
...
* [milton2](https://github.com/miltonio/milton2) ⭐ 212 | 🐛 14 | 🌐 Java | 📅 2026-08-26 - Milton Java WebDAV / CalDAV / CardDAV Server Library. `Apache-2.0`
...
* [dav4jvm](https://github.com/bitfireAT/dav4jvm) ⭐ 103 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-01 - dav4jvm is a WebDAV/CalDAV/CardDAV library for JVM (Java/Kotlin) developed for DAVx⁵. `MPL-2.0`
...
* [perry-mitchell/webdav-client](https://github.com/perry-mitchell/webdav-client) ⭐ 817 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-03 - WebDAV client written in JavaScript for Node.js and the browser.
* [mikedeboer/jsDAV](https://github.com/mikedeboer/jsDAV) ⭐ 678 | 🐛 50 | 🌐 JavaScript | 📅 2017-07-24 - a Node.js port of SabreDAV with support of many features.
* [unifile](https://github.com/silexlabs/unifile) ⭐ 153 | 🐛 21 | 🌐 JavaScript | 📅 2022-03-17 - Node.js library to access cloud storage which supports WebDAV.
