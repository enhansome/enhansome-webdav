...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,419 | 🐛 254 | 🌐 Python | 📅 2026-08-23 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,372 | 🐛 73 | 🌐 Rust | 📅 2026-08-27 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,457 | 🐛 172 | 🌐 Go | 📅 2026-08-27 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,817 | 🐛 92 | 🌐 Rust | 📅 2026-08-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,803 | 🐛 22 | 🌐 Go | 📅 2026-08-26 - A simple yet configurable WebDAV server written in Go.
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,628 | 🐛 1,478 | 🌐 TypeScript | 📅 2026-08-27.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,988 | 🐛 440 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 874 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-27.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 478 | 🌐 C++ | 📅 2026-08-27 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,939 | 🐛 636 | 🌐 C# | 📅 2026-08-27 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,460 | 🐛 80 | 🌐 Dart | 📅 2026-08-27 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,460 | 🐛 80 | 🌐 Dart | 📅 2026-08-27. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,273 | 🐛 187 | 🌐 Kotlin | 📅 2026-08-26
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,535 | 🐛 1,559 | 🌐 Kotlin | 📅 2026-08-27 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,327 | 🐛 193 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,636 | 🐛 941 | 🌐 HTML | 📅 2026-08-26 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,198 | 🐛 111 | 🌐 Dart | 📅 2026-08-23 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,460 | 🐛 80 | 🌐 Dart | 📅 2026-08-27 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,460 | 🐛 80 | 🌐 Dart | 📅 2026-08-27. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,198 | 🐛 111 | 🌐 Dart | 📅 2026-08-23. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,460 | 🐛 80 | 🌐 Dart | 📅 2026-08-27 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,460 | 🐛 80 | 🌐 Dart | 📅 2026-08-27. `AL2` `Dart`  `Apache-2.0`
