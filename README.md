...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,460 | 🐛 251 | 🌐 Python | 📅 2026-08-31 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,456 | 🐛 69 | 🌐 Rust | 📅 2026-09-01 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,472 | 🐛 173 | 🌐 Go | 📅 2026-08-31 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,826 | 🐛 93 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,817 | 🐛 19 | 🌐 Go | 📅 2026-08-28 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 744 | 🐛 22 | 🌐 PHP | 📅 2026-07-30 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,686 | 🐛 13 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,724 | 🐛 1,454 | 🌐 TypeScript | 📅 2026-08-31.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,211 | 🐛 470 | 🌐 C++ | 📅 2026-09-01 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,954 | 🐛 623 | 🌐 C# | 📅 2026-09-01 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,524 | 🐛 79 | 🌐 Dart | 📅 2026-09-01 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,524 | 🐛 79 | 🌐 Dart | 📅 2026-09-01. `AL2` `Dart`  `Apache-2.0`
...
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,547 | 🐛 1,564 | 🌐 Kotlin | 📅 2026-09-01 `GPL-2.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,638 | 🐛 947 | 🌐 HTML | 📅 2026-08-30 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,206 | 🐛 1,167 | 🌐 C# | 📅 2026-08-20. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,232 | 🐛 110 | 🌐 Dart | 📅 2026-08-31 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,524 | 🐛 79 | 🌐 Dart | 📅 2026-09-01 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,524 | 🐛 79 | 🌐 Dart | 📅 2026-09-01. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,232 | 🐛 110 | 🌐 Dart | 📅 2026-08-31. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,524 | 🐛 79 | 🌐 Dart | 📅 2026-09-01 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,524 | 🐛 79 | 🌐 Dart | 📅 2026-09-01. `AL2` `Dart`  `Apache-2.0`
