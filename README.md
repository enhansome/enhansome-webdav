...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,501 | 🐛 255 | 🌐 Python | 📅 2026-09-01 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,520 | 🐛 67 | 🌐 Rust | 📅 2026-09-04 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,487 | 🐛 178 | 🌐 Go | 📅 2026-09-02 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,833 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,823 | 🐛 21 | 🌐 Go | 📅 2026-08-28 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,696 | 🐛 14 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,804 | 🐛 1,454 | 🌐 TypeScript | 📅 2026-09-04.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,992 | 🐛 440 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-03.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,209 | 🐛 474 | 🌐 C++ | 📅 2026-09-03 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,964 | 🐛 620 | 🌐 C# | 📅 2026-09-04 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,540 | 🐛 79 | 🌐 Dart | 📅 2026-09-04 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,540 | 🐛 79 | 🌐 Dart | 📅 2026-09-04. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,308 | 🐛 190 | 🌐 Kotlin | 📅 2026-08-29
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,559 | 🐛 1,556 | 🌐 Kotlin | 📅 2026-09-04 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,344 | 🐛 193 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,639 | 🐛 956 | 🌐 HTML | 📅 2026-09-03 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,264 | 🐛 116 | 🌐 Dart | 📅 2026-08-31 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,540 | 🐛 79 | 🌐 Dart | 📅 2026-09-04 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,540 | 🐛 79 | 🌐 Dart | 📅 2026-09-04. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,264 | 🐛 116 | 🌐 Dart | 📅 2026-08-31. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,540 | 🐛 79 | 🌐 Dart | 📅 2026-09-04 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,540 | 🐛 79 | 🌐 Dart | 📅 2026-09-04. `AL2` `Dart`  `Apache-2.0`
