...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,518 | 🐛 255 | 🌐 Python | 📅 2026-09-01 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,536 | 🐛 67 | 🌐 Rust | 📅 2026-09-04 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,491 | 🐛 178 | 🌐 Go | 📅 2026-09-02 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,836 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,824 | 🐛 21 | 🌐 Go | 📅 2026-09-05 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,698 | 🐛 14 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,814 | 🐛 1,463 | 🌐 TypeScript | 📅 2026-09-05.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,991 | 🐛 440 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-04.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 475 | 🌐 C++ | 📅 2026-09-03 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,965 | 🐛 622 | 🌐 C# | 📅 2026-09-04 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
* [ioBroker.backitup](https://github.com/simatec/ioBroker.backitup) ⭐ 72 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-22 - a module for ioBroker home automation.
* [rclone](https://rclone.org/) - Supports WebDAV as a backup target and [can itself act as a WebDAV server](https://rclone.org/commands/rclone_serve_webdav/) (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,544 | 🐛 79 | 🌐 Dart | 📅 2026-09-04 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,544 | 🐛 79 | 🌐 Dart | 📅 2026-09-04. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,310 | 🐛 190 | 🌐 Kotlin | 📅 2026-08-29
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,560 | 🐛 1,544 | 🌐 Kotlin | 📅 2026-09-05 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,345 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,641 | 🐛 957 | 🌐 HTML | 📅 2026-09-03 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,271 | 🐛 118 | 🌐 Dart | 📅 2026-09-05 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,544 | 🐛 79 | 🌐 Dart | 📅 2026-09-04 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,544 | 🐛 79 | 🌐 Dart | 📅 2026-09-04. `AL2` `Dart`  `Apache-2.0`
* [SimpleTask](https://github.com/mpcjanssen/simpletask-android) ⚠️ Archived - a simple task manager. `GPL3` `Kotlin`
* [ntodotxt](https://github.com/tmaegel/ntodotxt) ⭐ 222 | 🐛 40 | 🌐 Dart | 📅 2026-08-14 - TODO App with sync via WebDAV. `MIT`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,271 | 🐛 118 | 🌐 Dart | 📅 2026-09-05. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,544 | 🐛 79 | 🌐 Dart | 📅 2026-09-04 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,544 | 🐛 79 | 🌐 Dart | 📅 2026-09-04. `AL2` `Dart`  `Apache-2.0`
