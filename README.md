...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,330 | 🐛 254 | 🌐 Python | 📅 2026-08-17 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,310 | 🐛 72 | 🌐 Rust | 📅 2026-08-22 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,427 | 🐛 172 | 🌐 Go | 📅 2026-08-13 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,805 | 🐛 91 | 🌐 Rust | 📅 2026-08-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,793 | 🐛 20 | 🌐 Go | 📅 2026-08-22 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,652 | 🐛 12 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,528 | 🐛 1,464 | 🌐 TypeScript | 📅 2026-08-22.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,984 | 🐛 440 | 🌐 HTML | 📅 2026-05-08
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 475 | 🌐 C++ | 📅 2026-08-22 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,918 | 🐛 637 | 🌐 C# | 📅 2026-08-22 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,458 | 🐛 78 | 🌐 Dart | 📅 2026-08-22 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,458 | 🐛 78 | 🌐 Dart | 📅 2026-08-22. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,248 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-21
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,523 | 🐛 1,550 | 🌐 Kotlin | 📅 2026-08-23 `GPL-2.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,630 | 🐛 935 | 🌐 HTML | 📅 2026-08-21 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,161 | 🐛 107 | 🌐 Dart | 📅 2026-08-22 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,458 | 🐛 78 | 🌐 Dart | 📅 2026-08-22 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,458 | 🐛 78 | 🌐 Dart | 📅 2026-08-22. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,161 | 🐛 107 | 🌐 Dart | 📅 2026-08-22. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,458 | 🐛 78 | 🌐 Dart | 📅 2026-08-22 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,458 | 🐛 78 | 🌐 Dart | 📅 2026-08-22. `AL2` `Dart`  `Apache-2.0`
