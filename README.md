...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,638 | 🐛 251 | 🌐 Python | 📅 2026-09-08 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,632 | 🐛 68 | 🌐 Rust | 📅 2026-09-11 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,509 | 🐛 176 | 🌐 Go | 📅 2026-09-07 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,848 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,844 | 🐛 18 | 🌐 Go | 📅 2026-09-12 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,726 | 🐛 18 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,967 | 🐛 1,441 | 🌐 TypeScript | 📅 2026-09-12.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,991 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 876 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-11.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,985 | 🐛 627 | 🌐 C# | 📅 2026-09-11 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
* [ioBroker.backitup](https://github.com/simatec/ioBroker.backitup) ⭐ 72 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-11 - a module for ioBroker home automation.
* [rclone](https://rclone.org/) - Supports WebDAV as a backup target and [can itself act as a WebDAV server](https://rclone.org/commands/rclone_serve_webdav/) (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,563 | 🐛 80 | 🌐 Dart | 📅 2026-09-11 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,563 | 🐛 80 | 🌐 Dart | 📅 2026-09-11. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,334 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-11
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,573 | 🐛 1,555 | 🌐 Kotlin | 📅 2026-09-12 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,350 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
* [RCX](https://github.com/x0b/rcx) ⭐ 2,041 | 🐛 144 | 🌐 Java | 📅 2023-11-26 Rclone sync for Android (unmaintained, use Round Sync). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,658 | 🐛 962 | 🌐 HTML | 📅 2026-09-09 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,225 | 🐛 1,171 | 🌐 C# | 📅 2026-09-09. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,337 | 🐛 127 | 🌐 Dart | 📅 2026-09-07 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,563 | 🐛 80 | 🌐 Dart | 📅 2026-09-11 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,563 | 🐛 80 | 🌐 Dart | 📅 2026-09-11. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,337 | 🐛 127 | 🌐 Dart | 📅 2026-09-07. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,563 | 🐛 80 | 🌐 Dart | 📅 2026-09-11 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,563 | 🐛 80 | 🌐 Dart | 📅 2026-09-11. `AL2` `Dart`  `Apache-2.0`
...
* [perry-mitchell/webdav-client](https://github.com/perry-mitchell/webdav-client) ⭐ 817 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-03 - WebDAV client written in JavaScript for Node.js and the browser.
