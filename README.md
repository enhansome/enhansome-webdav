...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,761 | 🐛 248 | 🌐 Python | 📅 2026-09-20 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,762 | 🐛 69 | 🌐 Rust | 📅 2026-09-21 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,553 | 🐛 179 | 🌐 Go | 📅 2026-09-19 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,869 | 🐛 92 | 🌐 Rust | 📅 2026-09-18 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,873 | 🐛 16 | 🌐 Go | 📅 2026-09-20 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 751 | 🐛 18 | 🌐 PHP | 📅 2026-09-21 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,772 | 🐛 18 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 22,199 | 🐛 1,455 | 🌐 TypeScript | 📅 2026-09-21.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,996 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 874 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-20.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,218 | 🐛 481 | 🌐 C++ | 📅 2026-09-08 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 15,018 | 🐛 634 | 🌐 C# | 📅 2026-09-22 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,589 | 🐛 78 | 🌐 Dart | 📅 2026-09-21 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,589 | 🐛 78 | 🌐 Dart | 📅 2026-09-21. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,369 | 🐛 188 | 🌐 Kotlin | 📅 2026-09-22
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,589 | 🐛 1,550 | 🌐 Kotlin | 📅 2026-09-22 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,370 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
* [RCX](https://github.com/x0b/rcx) ⭐ 2,047 | 🐛 144 | 🌐 Java | 📅 2023-11-26 Rclone sync for Android (unmaintained, use Round Sync). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,676 | 🐛 965 | 🌐 HTML | 📅 2026-09-20 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,240 | 🐛 1,177 | 🌐 C# | 📅 2026-09-17. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,409 | 🐛 130 | 🌐 Dart | 📅 2026-09-13 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,589 | 🐛 78 | 🌐 Dart | 📅 2026-09-21 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,589 | 🐛 78 | 🌐 Dart | 📅 2026-09-21. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,409 | 🐛 130 | 🌐 Dart | 📅 2026-09-13. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,589 | 🐛 78 | 🌐 Dart | 📅 2026-09-21 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,589 | 🐛 78 | 🌐 Dart | 📅 2026-09-21. `AL2` `Dart`  `Apache-2.0`
...
* [neon](https://github.com/notroj/neon) ⭐ 165 | 🐛 6 | 🌐 C | 📅 2026-09-15 - An HTTP/1.1 and WebDAV client library with a C API.
...
* [go-webdav](https://github.com/emersion/go-webdav) ⭐ 498 | 🐛 56 | 🌐 Go | 📅 2026-06-28 - Client library for WebDAV, CalDAV and CardDAV.
...
* [dav4jvm](https://github.com/bitfireAT/dav4jvm) ⭐ 104 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-22 - dav4jvm is a WebDAV/CalDAV/CardDAV library for JVM (Java/Kotlin) developed for DAVx⁵. `MPL-2.0`
...
* [perry-mitchell/webdav-client](https://github.com/perry-mitchell/webdav-client) ⭐ 818 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-19 - WebDAV client written in JavaScript for Node.js and the browser.
