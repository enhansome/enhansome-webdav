...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,554 | 🐛 249 | 🌐 Python | 📅 2026-09-06 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,563 | 🐛 67 | 🌐 Rust | 📅 2026-09-06 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,496 | 🐛 178 | 🌐 Go | 📅 2026-09-02 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,840 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,834 | 🐛 21 | 🌐 Go | 📅 2026-09-05 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 746 | 🐛 23 | 🌐 PHP | 📅 2026-09-06 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,702 | 🐛 16 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,859 | 🐛 1,469 | 🌐 TypeScript | 📅 2026-09-07.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,993 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 473 | 🌐 C++ | 📅 2026-09-06 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,973 | 🐛 624 | 🌐 C# | 📅 2026-09-07 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,551 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,551 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,322 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-06
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,567 | 🐛 1,545 | 🌐 Kotlin | 📅 2026-09-07 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,348 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,647 | 🐛 959 | 🌐 HTML | 📅 2026-09-05 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,213 | 🐛 1,170 | 🌐 C# | 📅 2026-09-06. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,296 | 🐛 121 | 🌐 Dart | 📅 2026-09-06 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,551 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,551 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,296 | 🐛 121 | 🌐 Dart | 📅 2026-09-06. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,551 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,551 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
