...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,428 | 🐛 255 | 🌐 Python | 📅 2026-08-23 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,383 | 🐛 72 | 🌐 Rust | 📅 2026-08-28 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,462 | 🐛 172 | 🌐 Go | 📅 2026-08-27 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,821 | 🐛 92 | 🌐 Rust | 📅 2026-08-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,809 | 🐛 19 | 🌐 Go | 📅 2026-08-28 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,663 | 🐛 13 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,642 | 🐛 1,443 | 🌐 TypeScript | 📅 2026-08-28.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 472 | 🌐 C++ | 📅 2026-08-28 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,943 | 🐛 639 | 🌐 C# | 📅 2026-08-28 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,495 | 🐛 78 | 🌐 Dart | 📅 2026-08-28 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,495 | 🐛 78 | 🌐 Dart | 📅 2026-08-28. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,277 | 🐛 187 | 🌐 Kotlin | 📅 2026-08-27
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,539 | 🐛 1,561 | 🌐 Kotlin | 📅 2026-08-28 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,328 | 🐛 193 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,635 | 🐛 942 | 🌐 HTML | 📅 2026-08-26 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,201 | 🐛 112 | 🌐 Dart | 📅 2026-08-23 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,495 | 🐛 78 | 🌐 Dart | 📅 2026-08-28 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,495 | 🐛 78 | 🌐 Dart | 📅 2026-08-28. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,201 | 🐛 112 | 🌐 Dart | 📅 2026-08-23. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,495 | 🐛 78 | 🌐 Dart | 📅 2026-08-28 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,495 | 🐛 78 | 🌐 Dart | 📅 2026-08-28. `AL2` `Dart`  `Apache-2.0`
