...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,788 | 🐛 250 | 🌐 Python | 📅 2026-09-24 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,810 | 🐛 69 | 🌐 Rust | 📅 2026-09-25 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,576 | 🐛 177 | 🌐 Go | 📅 2026-09-24 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,873 | 🐛 92 | 🌐 Rust | 📅 2026-09-18 - A file sharing server, supports read-only WebDAV
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,785 | 🐛 19 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 22,243 | 🐛 1,421 | 🌐 TypeScript | 📅 2026-09-25.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,219 | 🐛 482 | 🌐 C++ | 📅 2026-09-08 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 15,024 | 🐛 629 | 🌐 C# | 📅 2026-09-23 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,597 | 🐛 79 | 🌐 Dart | 📅 2026-09-24 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,597 | 🐛 79 | 🌐 Dart | 📅 2026-09-24. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,379 | 🐛 188 | 🌐 Kotlin | 📅 2026-09-24
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,593 | 🐛 1,545 | 🌐 Kotlin | 📅 2026-09-25 `GPL-2.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,684 | 🐛 968 | 🌐 HTML | 📅 2026-09-24 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,249 | 🐛 1,181 | 🌐 C# | 📅 2026-09-17. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,422 | 🐛 123 | 🌐 Dart | 📅 2026-09-25 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,597 | 🐛 79 | 🌐 Dart | 📅 2026-09-24 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,597 | 🐛 79 | 🌐 Dart | 📅 2026-09-24. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,422 | 🐛 123 | 🌐 Dart | 📅 2026-09-25. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,597 | 🐛 79 | 🌐 Dart | 📅 2026-09-24 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,597 | 🐛 79 | 🌐 Dart | 📅 2026-09-24. `AL2` `Dart`  `Apache-2.0`
