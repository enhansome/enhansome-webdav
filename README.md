...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,293 | 🐛 247 | 🌐 Python | 📅 2026-08-17 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,254 | 🐛 73 | 🌐 Rust | 📅 2026-08-18 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,412 | 🐛 171 | 🌐 Go | 📅 2026-08-13 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,798 | 🐛 88 | 🌐 Rust | 📅 2026-08-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,778 | 🐛 18 | 🌐 Go | 📅 2026-08-19 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,636 | 🐛 12 | 🌐 Rust | 📅 2026-06-29
...
* [nginx](https://nginx.org/en/docs/http/ngx_http_dav_module.html) - Supports a subset of WebDAV methods via the `ngx_http_dav_module` module.
  * [`nginx-dav-ext-module`](https://github.com/arut/nginx-dav-ext-module) ⭐ 510 | 🐛 32 | 🌐 C | 📅 2024-05-18 - Unofficial module that adds full WebDAV support.
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,440 | 🐛 1,462 | 🌐 TypeScript | 📅 2026-08-17.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,979 | 🐛 440 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 874 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-18.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,208 | 🐛 478 | 🌐 C++ | 📅 2026-08-18 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,899 | 🐛 643 | 🌐 C# | 📅 2026-08-18 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
* [ioBroker.backitup](https://github.com/simatec/ioBroker.backitup) ⭐ 72 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-18 - a module for ioBroker home automation.
* [rclone](https://rclone.org/) - Supports WebDAV as a backup target and [can itself act as a WebDAV server](https://rclone.org/commands/rclone_serve_webdav/) (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-16 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-16. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,229 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-17
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,515 | 🐛 1,549 | 🌐 Kotlin | 📅 2026-08-19 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,314 | 🐛 193 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [EasySync](https://github.com/phpbg/easysync) ⭐ 231 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-15 - backup and sync files with WebDAV share. `MIT`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,621 | 🐛 967 | 🌐 HTML | 📅 2026-08-18 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,189 | 🐛 1,162 | 🌐 C# | 📅 2026-08-17. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,143 | 🐛 103 | 🌐 Dart | 📅 2026-08-17 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-16 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-16. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,143 | 🐛 103 | 🌐 Dart | 📅 2026-08-17. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-16 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-16. `AL2` `Dart`  `Apache-2.0`
