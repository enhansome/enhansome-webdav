...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,567 | 🐛 249 | 🌐 Python | 📅 2026-09-08 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,581 | 🐛 69 | 🌐 Rust | 📅 2026-09-08 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,497 | 🐛 175 | 🌐 Go | 📅 2026-09-07 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,842 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,836 | 🐛 21 | 🌐 Go | 📅 2026-09-07 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 745 | 🐛 23 | 🌐 PHP | 📅 2026-09-06 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
* [dave](https://github.com/micromata/dave/) ⚠️ Archived - a simple WebDAV server written in Go. `Apache-2.0` `Golang`
* [Seafile](https://github.com/haiwen/seafdav) ⭐ 92 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - A webdav server written in Python
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,709 | 🐛 16 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,885 | 🐛 1,476 | 🌐 TypeScript | 📅 2026-09-07.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,992 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-07.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 474 | 🌐 C++ | 📅 2026-09-06 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,975 | 🐛 622 | 🌐 C# | 📅 2026-09-08 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
* [ioBroker.backitup](https://github.com/simatec/ioBroker.backitup) ⭐ 72 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-22 - a module for ioBroker home automation.
* [rclone](https://rclone.org/) - Supports WebDAV as a backup target and [can itself act as a WebDAV server](https://rclone.org/commands/rclone_serve_webdav/) (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,555 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,555 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,323 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-07
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,569 | 🐛 1,551 | 🌐 Kotlin | 📅 2026-09-08 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,349 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,648 | 🐛 958 | 🌐 HTML | 📅 2026-09-07 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,217 | 🐛 1,170 | 🌐 C# | 📅 2026-09-06. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,305 | 🐛 123 | 🌐 Dart | 📅 2026-09-07 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,555 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,555 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,305 | 🐛 123 | 🌐 Dart | 📅 2026-09-07. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,555 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,555 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [milton2](https://github.com/miltonio/milton2) ⭐ 211 | 🐛 14 | 🌐 Java | 📅 2026-08-26 - Milton Java WebDAV / CalDAV / CardDAV Server Library. `Apache-2.0`
