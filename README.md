...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,302 | 🐛 249 | 🌐 Python | 📅 2026-08-17 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,258 | 🐛 73 | 🌐 Rust | 📅 2026-08-19 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
...
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,780 | 🐛 17 | 🌐 Go | 📅 2026-08-19 - A simple yet configurable WebDAV server written in Go.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,638 | 🐛 12 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,445 | 🐛 1,466 | 🌐 TypeScript | 📅 2026-08-17.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,904 | 🐛 642 | 🌐 C# | 📅 2026-08-19 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-19 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-19. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,231 | 🐛 186 | 🌐 Kotlin | 📅 2026-08-19
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,516 | 🐛 1,550 | 🌐 Kotlin | 📅 2026-08-19 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,316 | 🐛 193 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,621 | 🐛 933 | 🌐 HTML | 📅 2026-08-18 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,190 | 🐛 1,162 | 🌐 C# | 📅 2026-08-17. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,145 | 🐛 103 | 🌐 Dart | 📅 2026-08-17 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-19 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-19. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,145 | 🐛 103 | 🌐 Dart | 📅 2026-08-17. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-19 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,455 | 🐛 78 | 🌐 Dart | 📅 2026-08-19. `AL2` `Dart`  `Apache-2.0`
