...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,775 | 🐛 250 | 🌐 Python | 📅 2026-09-20 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,793 | 🐛 69 | 🌐 Rust | 📅 2026-09-24 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,572 | 🐛 177 | 🌐 Go | 📅 2026-09-19 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,872 | 🐛 92 | 🌐 Rust | 📅 2026-09-18 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,878 | 🐛 16 | 🌐 Go | 📅 2026-09-20 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 753 | 🐛 14 | 🌐 PHP | 📅 2026-09-23 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,782 | 🐛 18 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 22,225 | 🐛 1,454 | 🌐 TypeScript | 📅 2026-09-24.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,998 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 15,021 | 🐛 629 | 🌐 C# | 📅 2026-09-23 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,594 | 🐛 79 | 🌐 Dart | 📅 2026-09-24 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,594 | 🐛 79 | 🌐 Dart | 📅 2026-09-24. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,373 | 🐛 188 | 🌐 Kotlin | 📅 2026-09-22
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,591 | 🐛 1,548 | 🌐 Kotlin | 📅 2026-09-24 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,371 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
* [RCX](https://github.com/x0b/rcx) ⭐ 2,048 | 🐛 144 | 🌐 Java | 📅 2023-11-26 Rclone sync for Android (unmaintained, use Round Sync). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,680 | 🐛 971 | 🌐 HTML | 📅 2026-09-23 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,247 | 🐛 1,179 | 🌐 C# | 📅 2026-09-17. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,419 | 🐛 131 | 🌐 Dart | 📅 2026-09-23 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,594 | 🐛 79 | 🌐 Dart | 📅 2026-09-24 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,594 | 🐛 79 | 🌐 Dart | 📅 2026-09-24. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,419 | 🐛 131 | 🌐 Dart | 📅 2026-09-23. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,594 | 🐛 79 | 🌐 Dart | 📅 2026-09-24 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,594 | 🐛 79 | 🌐 Dart | 📅 2026-09-24. `AL2` `Dart`  `Apache-2.0`
