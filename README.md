...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,672 | 🐛 250 | 🌐 Python | 📅 2026-09-08 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,658 | 🐛 68 | 🌐 Rust | 📅 2026-09-13 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,518 | 🐛 176 | 🌐 Go | 📅 2026-09-07 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,855 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,854 | 🐛 18 | 🌐 Go | 📅 2026-09-12 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 747 | 🐛 16 | 🌐 PHP | 📅 2026-09-13 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,728 | 🐛 18 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 22,007 | 🐛 1,445 | 🌐 TypeScript | 📅 2026-09-14.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,992 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,991 | 🐛 629 | 🌐 C# | 📅 2026-09-11 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,569 | 🐛 80 | 🌐 Dart | 📅 2026-09-13 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,569 | 🐛 80 | 🌐 Dart | 📅 2026-09-13. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,338 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-14
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,579 | 🐛 1,560 | 🌐 Kotlin | 📅 2026-09-14 `GPL-2.0`
* [Round Sync](https://github.com/newhinton/Round-Sync) ⭐ 2,354 | 🐛 194 | 🌐 Java | 📅 2025-11-16 Rclone sync for Android (fork of RCX). `GPL-3.0`
* [RCX](https://github.com/x0b/rcx) ⭐ 2,044 | 🐛 144 | 🌐 Java | 📅 2023-11-26 Rclone sync for Android (unmaintained, use Round Sync). `GPL-3.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,660 | 🐛 963 | 🌐 HTML | 📅 2026-09-12 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,227 | 🐛 1,171 | 🌐 C# | 📅 2026-09-14. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,345 | 🐛 127 | 🌐 Dart | 📅 2026-09-13 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,569 | 🐛 80 | 🌐 Dart | 📅 2026-09-13 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,569 | 🐛 80 | 🌐 Dart | 📅 2026-09-13. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,345 | 🐛 127 | 🌐 Dart | 📅 2026-09-13. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,569 | 🐛 80 | 🌐 Dart | 📅 2026-09-13 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,569 | 🐛 80 | 🌐 Dart | 📅 2026-09-13. `AL2` `Dart`  `Apache-2.0`
...
* [neon](https://github.com/notroj/neon) ⭐ 165 | 🐛 4 | 🌐 C | 📅 2026-09-13 - An HTTP/1.1 and WebDAV client library with a C API.
...
* [go-webdav](https://github.com/emersion/go-webdav) ⭐ 497 | 🐛 57 | 🌐 Go | 📅 2026-06-28 - Client library for WebDAV, CalDAV and CardDAV.
...
* [dav4jvm](https://github.com/bitfireAT/dav4jvm) ⭐ 103 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-14 - dav4jvm is a WebDAV/CalDAV/CardDAV library for JVM (Java/Kotlin) developed for DAVx⁵. `MPL-2.0`
