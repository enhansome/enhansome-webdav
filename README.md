...
* [copyparty](https://github.com/9001/copyparty) ⭐ 46,607 | 🐛 251 | 🌐 Python | 📅 2026-09-08 - a portable file server with resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbnails. It has an [Android app](https://f-droid.org/packages/me.ocv.partyup/).  `MIT` `Python`
* [Stalwart](https://github.com/stalwartlabs/stalwart) ⭐ 14,608 | 🐛 68 | 🌐 Rust | 📅 2026-09-10 - Open-source Mailserver and WebDAV, CalDAV and CardDAV server written in Rust.
* [SFTPGo](https://github.com/drakkan/sftpgo) ⭐ 12,498 | 🐛 175 | 🌐 Go | 📅 2026-09-07 - SFTP server with optional FTP/S and WebDAV support.
* [miniserve](https://github.com/svenstaro/miniserve) ⭐ 7,845 | 🐛 92 | 🌐 Rust | 📅 2026-09-01 - A file sharing server, supports read-only WebDAV
* [hacdias-webdav](https://github.com/hacdias/webdav) ⭐ 5,840 | 🐛 16 | 🌐 Go | 📅 2026-09-08 - A simple yet configurable WebDAV server written in Go.
* [Davis](https://github.com/tchapi/davis) ⭐ 746 | 🐛 21 | 🌐 PHP | 📅 2026-09-09 - a simple interfacefor `sabre/dav` based on `Symfony` and `Bootstrap`, largely inspired by `Baïkal`.
...
* "Written in Rust". They all are similar to weborf by functionality but more advanced and fancy
  * [sigoden/dufs](https://github.com/sigoden/dufs) ⭐ 10,719 | 🐛 18 | 🌐 Rust | 📅 2026-06-29
...
* [Supper Productivity](https://app.super-productivity.com/) - A powerful TODO App. [Source code](https://github.com/johannesjo/super-productivity) ⭐ 21,930 | 🐛 1,489 | 🌐 TypeScript | 📅 2026-09-09.
* [KeeWeb](https://app.keeweb.info/) - A password manager [Source code](https://github.com/keeweb/keeweb) ⭐ 12,991 | 🐛 441 | 🌐 HTML | 📅 2026-05-08
* [Diffuse](https://diffuse.sh/) - an onine music player [Source code](https://github.com/icidasset/diffuse) ⭐ 875 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-09.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 474 | 🌐 C++ | 📅 2026-09-08 - A heavily rewritten Linux and MacOS port of FAR Manager. Has a NetRocks plugin with WebDAV support.
...
* [Duplicati](https://github.com/duplicati/duplicati) ⭐ 14,979 | 🐛 630 | 🌐 C# | 📅 2026-09-10 - Supports WebDAV as a backup target (for Windows, Mac and Linux).
* [ioBroker.backitup](https://github.com/simatec/ioBroker.backitup) ⭐ 72 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - a module for ioBroker home automation.
* [rclone](https://rclone.org/) - Supports WebDAV as a backup target and [can itself act as a WebDAV server](https://rclone.org/commands/rclone_serve_webdav/) (for Windows, Mac and Linux).
...
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,560 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,560 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [Android DataBackup](https://github.com/XayahSuSuSu/Android-DataBackup) ⭐ 7,329 | 🐛 190 | 🌐 Kotlin | 📅 2026-09-09
* [NextCloud Android App](https://github.com/nextcloud/android) ⭐ 5,570 | 🐛 1,550 | 🌐 Kotlin | 📅 2026-09-10 `GPL-2.0`
...
* [NOVA](https://github.com/nova-video-player/aos-AVP) ⭐ 4,653 | 🐛 963 | 🌐 HTML | 📅 2026-09-09 - an open source video player with AndroidTV support. `Apache-2.0`
...
* [Keepass2Android](https://play.google.com/store/apps/details?id=keepass2android.keepass2android) - KeePass-based password manager that supports WebDAV sync. [Sources](https://github.com/PhilippC/keepass2android) ⭐ 6,222 | 🐛 1,171 | 🌐 C# | 📅 2026-09-09. `GPL3`
* [BeeCount](https://github.com/TNT-Likely/BeeCount) ⭐ 2,317 | 🐛 124 | 🌐 Dart | 📅 2026-09-07 – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,560 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,560 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [BeeCount](https://apps.apple.com/app/id6754611670) – Privacy-first expense tracker with multi-backend cloud sync including WebDAV. [Source](https://github.com/TNT-Likely/BeeCount) ⭐ 2,317 | 🐛 124 | 🌐 Dart | 📅 2026-09-07. `Source-Available` `Dart`
* [Table Habit](https://github.com/FriesI23/mhabit) ⭐ 1,560 | 🐛 79 | 🌐 Dart | 📅 2026-09-07 – Micro habits tracking app with [sync via WebDAV](https://github.com/FriesI23/mhabit/wiki/Feature%EA%9E%89-WebDAV-Sync) ⭐ 1,560 | 🐛 79 | 🌐 Dart | 📅 2026-09-07. `AL2` `Dart`  `Apache-2.0`
...
* [perry-mitchell/webdav-client](https://github.com/perry-mitchell/webdav-client) ⭐ 816 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-03 - WebDAV client written in JavaScript for Node.js and the browser.
